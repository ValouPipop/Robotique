...
grid = grille_epaisse.T  # Transpose pour le calcul [x, y] avec la grille épaissie
...
if __name__ == '__main__':
    ...
    # On affiche la grille_epaisse pour voir l'effet de l'inflation
